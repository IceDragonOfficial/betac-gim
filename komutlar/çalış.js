...
exports.run = async (client, message, args) => {
 ...
 message.channel.send({ content: `Çok çalıştın ve karşılığında **${Covid}**  Beta Coin.`, reply: { messageReference: message.id }});
 } else if(iş === "onbaşı") {
 ...
 db.topla(`para_${message.author.id}`, Covid)
 message.channel.send({ content: `Çok çalıştın ve karşılığında **${Covid}** Beta Coin aldın.`, reply: { messageReference: message.id }});
} else if(iş === "binbaşı") {
